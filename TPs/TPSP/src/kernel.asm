...
; Inicializar el PIT para aumentar la frecuencia de las interrupciones del reloj
    mov ax, 0x400   ; Ajustar ax para hacer el juego "mas rapido" o "mas lento"
    out 0x40, al
    rol ax, 8
    out 0x40, al
...
; Todo lo q esta debajo de aca habria q borrarlo/comentarlo o como no jode con el juego dejarlo como esta?
